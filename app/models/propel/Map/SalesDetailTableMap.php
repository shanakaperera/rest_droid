...
class SalesDetailTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.SalesDetailTableMap';
     ...
     */
    const OM_CLASS = '\\SalesDetail';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SalesDetail';
     ...
     */
    const COL_PRICE = 'sales_detail.price';

    /**
     * the column name for the qnty field
     */
    const COL_QNTY = 'sales_detail.qnty';

    /**
     * the column name for the sales_header_id field
     */
    const COL_SALES_HEADER_ID = 'sales_detail.sales_header_id';

    /**
     * the column name for the product_id field
     */
    const COL_PRODUCT_ID = 'sales_detail.product_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Price', 'Qnty', 'SalesHeaderId', 'ProductId', ),
        self::TYPE_CAMELNAME     => array('id', 'price', 'qnty', 'salesHeaderId', 'productId', ),
        self::TYPE_COLNAME       => array(SalesDetailTableMap::COL_ID, SalesDetailTableMap::COL_PRICE, SalesDetailTableMap::COL_QNTY, SalesDetailTableMap::COL_SALES_HEADER_ID, SalesDetailTableMap::COL_PRODUCT_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'price', 'qnty', 'sales_header_id', 'product_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Price' => 1, 'Qnty' => 2, 'SalesHeaderId' => 3, 'ProductId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'price' => 1, 'qnty' => 2, 'salesHeaderId' => 3, 'productId' => 4, ),
        self::TYPE_COLNAME       => array(SalesDetailTableMap::COL_ID => 0, SalesDetailTableMap::COL_PRICE => 1, SalesDetailTableMap::COL_QNTY => 2, SalesDetailTableMap::COL_SALES_HEADER_ID => 3, SalesDetailTableMap::COL_PRODUCT_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'price' => 1, 'qnty' => 2, 'sales_header_id' => 3, 'product_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SalesDetail');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('price', 'Price', 'DOUBLE', false, null, null);
        $this->addColumn('qnty', 'Qnty', 'INTEGER', false, null, null);
        $this->addForeignKey('sales_header_id', 'SalesHeaderId', 'INTEGER', 'sales_header', 'id', true, null, null);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('SalesHeader', '\\SalesHeader', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':sales_header_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SalesDetailTableMap::COL_PRICE);
            $criteria->addSelectColumn(SalesDetailTableMap::COL_QNTY);
            $criteria->addSelectColumn(SalesDetailTableMap::COL_SALES_HEADER_ID);
            $criteria->addSelectColumn(SalesDetailTableMap::COL_PRODUCT_ID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.price');
            $criteria->addSelectColumn($alias . '.qnty');
            $criteria->addSelectColumn($alias . '.sales_header_id');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SalesDetail) { // it's a model object
