...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'mob_db', $modelName = '\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, user_name, password, email, status, image, type FROM user WHERE id = :p0';
        try {
