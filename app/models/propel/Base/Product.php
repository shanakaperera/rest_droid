...
abstract class Product implements ActiveRecordInterface
{
    ...
    public function setDateAdded($v)
    {
        ...
        if ($this->date_added !== null || $dt !== null) {
            if ($this->date_added === null || $dt === null || $dt->format("Y-m-d") !== $this->date_added->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ProductTableMap::COL_DATE_ADDED] = true;
            }
    ...
    public function setDateUpdated($v)
    {
        ...
        if ($this->date_updated !== null || $dt !== null) {
            if ($this->date_updated === null || $dt === null || $dt->format("Y-m-d") !== $this->date_updated->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ProductTableMap::COL_DATE_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function setOfferId($v)
    {
        ...
        if ($this->offer_id !== $v) {
            $this->offer_id = $v;
            $this->modifiedColumns[ProductTableMap::COL_OFFER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductTableMap::translateFieldName('DateAdded', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_added = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProductTableMap::translateFieldName('DateUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProductTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ProductTableMap::translateFieldName('Image', TableMap::TYPE_PHPNAME, $indexType)];
            $this->image = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ProductTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ProductTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ProductTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ProductTableMap::translateFieldName('OfferId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_DATE_ADDED)) {
            $modifiedColumns[':p' . $index++]  = 'date_added';
        }
        if ($this->isColumnModified(ProductTableMap::COL_DATE_UPDATED)) {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_OFFER_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_DATE_ADDED)) {
            $criteria->add(ProductTableMap::COL_DATE_ADDED, $this->date_added);
        }
        if ($this->isColumnModified(ProductTableMap::COL_DATE_UPDATED)) {
            $criteria->add(ProductTableMap::COL_DATE_UPDATED, $this->date_updated);
        }
        if ($this->isColumnModified(ProductTableMap::COL_DESCRIPTION)) {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_OFFER_ID)) {
            $criteria->add(ProductTableMap::COL_OFFER_ID, $this->offer_id);
        }
    ...
    public function initBanners($overrideExisting = true)
    {
        ...
        $this->collBanners->setModel('\Banner');
    }
    ...
    public function removeBanner(ChildBanner $banner)
    {
        if ($this->getBanners()->contains($banner)) {
            ...
            $this->bannersScheduledForDeletion[]= clone $banner;
    ...
    public function setSalesDetails(Collection $salesDetails, ConnectionInterface $con = null)
    {
        ...
        foreach ($salesDetailsToDelete as $salesDetailRemoved) {
            $salesDetailRemoved->setProduct(null);
        }
     ...
     * @return ObjectCollection|ChildSalesDetail[] List of ChildSalesDetail objects
     */
    public function getSalesDetailsJoinSalesHeader(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSalesDetailQuery::create(null, $criteria);
        $query->joinWith('SalesHeader', $joinBehavior);
