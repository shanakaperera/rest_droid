...
abstract class Client implements ActiveRecordInterface
{
    ...
    /**
     * The value for the android_id field.
     *
     * @var        string
     */
    ...
    /**
     * The value for the wifi_name field.
     *
     * @var        string
     */
    protected $wifi_name;
    ...
    /**
     * Get the [android_id] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [wifi_name] column value.
     *
     * @return string
     */
    ...
    public function setDateAdded($v)
    {
        ...
        if ($this->date_added !== null || $dt !== null) {
            if ($this->date_added === null || $dt === null || $dt->format("Y-m-d") !== $this->date_added->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ClientTableMap::COL_DATE_ADDED] = true;
            }
    ...
    public function setDateUpdated($v)
    {
        ...
        if ($this->date_updated !== null || $dt !== null) {
            if ($this->date_updated === null || $dt === null || $dt->format("Y-m-d") !== $this->date_updated->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ClientTableMap::COL_DATE_UPDATED] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [android_id] column.
     *
     * @param string $v new value
     * @return $this|\Client The current object (for fluent API support)
     */
    public function setAndroidId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->android_id !== $v) {
            $this->android_id = $v;
            $this->modifiedColumns[ClientTableMap::COL_ANDROID_ID] = true;
        }
    ...
    /**
     * Set the value of [wifi_name] column.
     *
     * @param string $v new value
     * @return $this|\Client The current object (for fluent API support)
     */
    public function setWifiName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->wifi_name !== $v) {
            $this->wifi_name = $v;
            $this->modifiedColumns[ClientTableMap::COL_WIFI_NAME] = true;
        }
    ...
    public function setSerialNumber($v)
    {
        ...
        if ($this->serial_number !== $v) {
            ...
            $this->modifiedColumns[ClientTableMap::COL_SERIAL_NUMBER] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[ClientTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ClientTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ClientTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ClientTableMap::translateFieldName('DateAdded', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_added = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ClientTableMap::translateFieldName('DateUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_updated = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ClientTableMap::translateFieldName('AndroidId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->android_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ClientTableMap::translateFieldName('WifiName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wifi_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ClientTableMap::translateFieldName('SerialNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->serial_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ClientTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_DATE_ADDED)) {
            $modifiedColumns[':p' . $index++]  = 'date_added';
        }
        if ($this->isColumnModified(ClientTableMap::COL_DATE_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_updated';
        }
        if ($this->isColumnModified(ClientTableMap::COL_ANDROID_ID)) {
            $modifiedColumns[':p' . $index++]  = 'android_id';
        }
        if ($this->isColumnModified(ClientTableMap::COL_WIFI_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'wifi_name';
        }
        if ($this->isColumnModified(ClientTableMap::COL_SERIAL_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'serial_number';
        }
        if ($this->isColumnModified(ClientTableMap::COL_USER_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'date_updated':
                        ...
                        break;
                    case 'android_id':
                        $stmt->bindValue($identifier, $this->android_id, PDO::PARAM_STR);
                        break;
                    case 'wifi_name':
                        $stmt->bindValue($identifier, $this->wifi_name, PDO::PARAM_STR);
                        break;
                    case 'serial_number':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getAndroidId(),
            $keys[7] => $this->getWifiName(),
            $keys[8] => $this->getSerialNumber(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                $this->setAndroidId($value);
                break;
            case 7:
                $this->setWifiName($value);
                break;
            case 8:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setAndroidId($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setWifiName($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setSerialNumber($arr[$keys[8]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_DATE_ADDED)) {
            $criteria->add(ClientTableMap::COL_DATE_ADDED, $this->date_added);
        }
        if ($this->isColumnModified(ClientTableMap::COL_DATE_UPDATED)) {
            $criteria->add(ClientTableMap::COL_DATE_UPDATED, $this->date_updated);
        }
        if ($this->isColumnModified(ClientTableMap::COL_ANDROID_ID)) {
            $criteria->add(ClientTableMap::COL_ANDROID_ID, $this->android_id);
        }
        if ($this->isColumnModified(ClientTableMap::COL_WIFI_NAME)) {
            $criteria->add(ClientTableMap::COL_WIFI_NAME, $this->wifi_name);
        }
        if ($this->isColumnModified(ClientTableMap::COL_SERIAL_NUMBER)) {
            $criteria->add(ClientTableMap::COL_SERIAL_NUMBER, $this->serial_number);
        }
        if ($this->isColumnModified(ClientTableMap::COL_USER_ID)) {
            $criteria->add(ClientTableMap::COL_USER_ID, $this->user_id);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAndroidId($this->getAndroidId());
        $copyObj->setWifiName($this->getWifiName());
    ...
    public function setSalesHeaders(Collection $salesHeaders, ConnectionInterface $con = null)
    {
        ...
        foreach ($salesHeadersToDelete as $salesHeaderRemoved) {
            $salesHeaderRemoved->setClient(null);
        }
     ...
     * @return ObjectCollection|ChildSalesHeader[] List of ChildSalesHeader objects
     */
    public function getSalesHeadersJoinTableSer(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSalesHeaderQuery::create(null, $criteria);
        $query->joinWith('TableSer', $joinBehavior);
