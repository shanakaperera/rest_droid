...
use \Banner as ChildBanner;
use \BannerQuery as ChildBannerQuery;
use \Exception;
use \PDO;
use Map\BannerTableMap;
...
/**
 * Base class that represents a query for the 'banner' table.
 *
 *
 *
 ...
 * @method     ChildBannerQuery orderByDateAdded($order = Criteria::ASC) Order by the date_added column
 * @method     ChildBannerQuery orderByDateUpdated($order = Criteria::ASC) Order by the date_updated column
 * @method     ChildBannerQuery orderByStatus($order = Criteria::ASC) Order by the status column
 * @method     ChildBannerQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 * @method     ChildBannerQuery orderByProductId($order = Criteria::ASC) Order by the product_id column
 *
 ...
 * @method     ChildBannerQuery groupByDateAdded() Group by the date_added column
 * @method     ChildBannerQuery groupByDateUpdated() Group by the date_updated column
 * @method     ChildBannerQuery groupByStatus() Group by the status column
 * @method     ChildBannerQuery groupByUserId() Group by the user_id column
 * @method     ChildBannerQuery groupByProductId() Group by the product_id column
 *
 ...
 *
 * @method     ChildBannerQuery leftJoinProduct($relationAlias = null) Adds a LEFT JOIN clause to the query using the Product relation
 * @method     ChildBannerQuery rightJoinProduct($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Product relation
 * @method     ChildBannerQuery innerJoinProduct($relationAlias = null) Adds a INNER JOIN clause to the query using the Product relation
 *
 * @method     ChildBannerQuery joinWithProduct($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Product relation
 *
 * @method     ChildBannerQuery leftJoinWithProduct() Adds a LEFT JOIN clause and with to the query using the Product relation
 * @method     ChildBannerQuery rightJoinWithProduct() Adds a RIGHT JOIN clause and with to the query using the Product relation
 * @method     ChildBannerQuery innerJoinWithProduct() Adds a INNER JOIN clause and with to the query using the Product relation
 *
 ...
 * @method     ChildBanner findOneByDateAdded(string $date_added) Return the first ChildBanner filtered by the date_added column
 * @method     ChildBanner findOneByDateUpdated(string $date_updated) Return the first ChildBanner filtered by the date_updated column
 * @method     ChildBanner findOneByStatus(boolean $status) Return the first ChildBanner filtered by the status column
 * @method     ChildBanner findOneByUserId(int $user_id) Return the first ChildBanner filtered by the user_id column
 * @method     ChildBanner findOneByProductId(int $product_id) Return the first ChildBanner filtered by the product_id column *
 ...
 * @method     ChildBanner requireOneByDateAdded(string $date_added) Return the first ChildBanner filtered by the date_added column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBanner requireOneByDateUpdated(string $date_updated) Return the first ChildBanner filtered by the date_updated column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBanner requireOneByStatus(boolean $status) Return the first ChildBanner filtered by the status column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBanner requireOneByUserId(int $user_id) Return the first ChildBanner filtered by the user_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBanner requireOneByProductId(int $product_id) Return the first ChildBanner filtered by the product_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildBanner[]|ObjectCollection findByDateAdded(string $date_added) Return ChildBanner objects filtered by the date_added column
 * @method     ChildBanner[]|ObjectCollection findByDateUpdated(string $date_updated) Return ChildBanner objects filtered by the date_updated column
 * @method     ChildBanner[]|ObjectCollection findByStatus(boolean $status) Return ChildBanner objects filtered by the status column
 * @method     ChildBanner[]|ObjectCollection findByUserId(int $user_id) Return ChildBanner objects filtered by the user_id column
 * @method     ChildBanner[]|ObjectCollection findByProductId(int $product_id) Return ChildBanner objects filtered by the product_id column
...
abstract class BannerQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\BannerQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'mob_db', $modelName = '\\Banner', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, description, date_added, date_updated, status, user_id, product_id FROM banner WHERE id = :p0';
        try {
    ...
    public function filterByDateAdded($dateAdded = null, $comparison = null)
    {
        if (is_array($dateAdded)) {
            ...
            if (isset($dateAdded['min'])) {
                $this->addUsingAlias(BannerTableMap::COL_DATE_ADDED, $dateAdded['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateAdded['max'])) {
                $this->addUsingAlias(BannerTableMap::COL_DATE_ADDED, $dateAdded['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BannerTableMap::COL_DATE_ADDED, $dateAdded, $comparison);
    }
    ...
    public function filterByDateUpdated($dateUpdated = null, $comparison = null)
    {
        if (is_array($dateUpdated)) {
            ...
            if (isset($dateUpdated['min'])) {
                $this->addUsingAlias(BannerTableMap::COL_DATE_UPDATED, $dateUpdated['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateUpdated['max'])) {
                $this->addUsingAlias(BannerTableMap::COL_DATE_UPDATED, $dateUpdated['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BannerTableMap::COL_DATE_UPDATED, $dateUpdated, $comparison);
    }
    ...
    public function filterByStatus($status = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BannerTableMap::COL_STATUS, $status, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(BannerTableMap::COL_USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(BannerTableMap::COL_USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BannerTableMap::COL_USER_ID, $userId, $comparison);
    }
    ...
    public function filterByProductId($productId = null, $comparison = null)
    {
        if (is_array($productId)) {
            ...
            if (isset($productId['min'])) {
                $this->addUsingAlias(BannerTableMap::COL_PRODUCT_ID, $productId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($productId['max'])) {
                $this->addUsingAlias(BannerTableMap::COL_PRODUCT_ID, $productId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BannerTableMap::COL_PRODUCT_ID, $productId, $comparison);
    }
    ...
    public function filterByProduct($product, $comparison = null)
    {
        if ($product instanceof \Product) {
            return $this
                ->addUsingAlias(BannerTableMap::COL_PRODUCT_ID, $product->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(BannerTableMap::COL_PRODUCT_ID, $product->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
