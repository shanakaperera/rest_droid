...
abstract class Banner implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BannerTableMap';
    ...
    /**
     * Initializes internal state of Base\Banner object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Banner The current object (for fluent API support)
     */
    ...
    public function setDateAdded($v)
    {
        ...
        if ($this->date_added !== null || $dt !== null) {
            if ($this->date_added === null || $dt === null || $dt->format("Y-m-d") !== $this->date_added->format("Y-m-d")) {
                ...
                $this->modifiedColumns[BannerTableMap::COL_DATE_ADDED] = true;
            }
    ...
    public function setDateUpdated($v)
    {
        ...
        if ($this->date_updated !== null || $dt !== null) {
            if ($this->date_updated === null || $dt === null || $dt->format("Y-m-d") !== $this->date_updated->format("Y-m-d")) {
                ...
                $this->modifiedColumns[BannerTableMap::COL_DATE_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[BannerTableMap::COL_STATUS] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[BannerTableMap::COL_USER_ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[BannerTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BannerTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BannerTableMap::translateFieldName('DateAdded', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_added = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BannerTableMap::translateFieldName('DateUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_updated = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BannerTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : BannerTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : BannerTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = BannerTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Banner'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BannerTableMap::COL_DATE_ADDED)) {
            $modifiedColumns[':p' . $index++]  = 'date_added';
        }
        if ($this->isColumnModified(BannerTableMap::COL_DATE_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_updated';
        }
        if ($this->isColumnModified(BannerTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(BannerTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(BannerTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_id';
        }

        $sql = sprintf(
            'INSERT INTO banner (%s) VALUES (%s)',
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setDateUpdated($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BannerTableMap::COL_DATE_ADDED)) {
            $criteria->add(BannerTableMap::COL_DATE_ADDED, $this->date_added);
        }
        if ($this->isColumnModified(BannerTableMap::COL_DATE_UPDATED)) {
            $criteria->add(BannerTableMap::COL_DATE_UPDATED, $this->date_updated);
        }
        if ($this->isColumnModified(BannerTableMap::COL_STATUS)) {
            $criteria->add(BannerTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(BannerTableMap::COL_USER_ID)) {
            $criteria->add(BannerTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(BannerTableMap::COL_PRODUCT_ID)) {
            $criteria->add(BannerTableMap::COL_PRODUCT_ID, $this->product_id);
        }
    ...
    {
        if (null !== $this->aProduct) {
            $this->aProduct->removeBanner($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(BannerTableMap::DEFAULT_STRING_FORMAT);
    }
